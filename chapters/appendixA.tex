...
reflection convention below is the one described in Section~4.8: vertices are
...
The check that found the one-pixel error described in Section~4.8. It rasterises
