...
\begin{enumerate}
    ...
    body, that swelling is annotated as a bead even though the fibre passes
    through it. In these micrographs this is the common case rather than the
    exception, which is why no distinction is drawn between a free bead and a
    thickened fibre segment.

    \item \textbf{A cluster is one object.} Where several small beads lie
...
about eighteen grey levels separating a bead from the surrounding mat, but
...
\begin{itemize}
    ...
    bead-to-mat difference.

    \item \textbf{Background subtraction.} The beads are darker than the mat,
    ...
    largest object present, and since the largest annotated bead spans 214
